...
tutorial_video = "https://youtu.be/w2m7J1AOIfU?si=dcYlbehQ4MQEVm71"
version = "1.0.4"
credits = "github.com/RoendarXD"

#CUSTOMIZE SETTINGS:

loop_delay = 0.3     #This is how many seconds it waits before starting a new loop.
click_delay = 0.25 #This is how many seconds it waits before clicking the mouse between each button. For example it clicks Send To, waits X seconds, then clicks your Shortcut, etc.


position_delay = 0.3 #I would recommend do not touch this. Does not affect the speed of the bot itself.
